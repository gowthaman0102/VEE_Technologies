...
type TimeRangeSelectorProps = { value: TimeRangePreset; onChange: (value: TimeRangePreset) => void; customStart?: string; customEnd?: string; onCustomStartChange?: (value: string) => void; onCustomEndChange?: (value: string) => void };
